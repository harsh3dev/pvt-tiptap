...
const SectionCardComponent: React.FC<NodeViewProps> = ({ 
  ...
  return (
    <NodeViewWrapper className="section-card-wrapper">
          {/* <div className="bg-white rounded-lg border border-gray-200 shadow-sm mb-4 overflow-hidden not-prose">
              <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                  <h3 className="text-lg font-medium text-gray-900">{node.attrs.title}</h3>
              </div>
          ...
          <div className="bg-gray-100 rounded-lg border border-gray-300 shadow-sm mb-4 p-4 overflow-hidden not-prose">
              <h3 className="text-xl text-gray-900 font-semibold mb-4">{node.attrs.title}</h3>

              <div className="relative bg-white border border-gray-200 rounded-lg p-2 shadow-sm">
                  <div className="flex items-center justify-between">                      <div className="p-2 prose prose-sm max-w-none text-gray-900">
                          <div
                              dangerouslySetInnerHTML={{
                                  __html: node.attrs.content
                              }}
                      ...
                      <button className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-50 transition-colors">
